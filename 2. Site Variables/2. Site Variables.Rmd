...
covs<-covs%>%
  mutate(disturbance_index = rowSums(across(4:107)))
...
#write.csv(wtd_dets_clean, file.path(output_directory, "final_df.csv"),
  #        row.names = FALSE)
